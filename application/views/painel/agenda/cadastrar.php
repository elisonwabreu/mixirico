...
get_msg('msgok');
get_msg('msgerro');
echo form_open_multipart('agenda/cadastrar', array('class'=>'form-horizontal'));
...
echo '<div class="col-md-6 col-xs-12">';
echo form_input(array('name'=>'data', 'class'=>'form-control'), set_value('data'));
echo '</div>';
echo '</div>';
echo '<div class="form-group">';
echo form_label('Hora','hora',array('class' => 'col-md-3 col-xs-12 control-label'));
echo '<div class="col-md-6 col-xs-12">';
echo form_input(array('name'=>'hora', 'class'=>'form-control'), set_value('hora'));
echo '</div>';
echo '</div>';
echo '<div class="form-group">';
echo form_label('Logradouro','logradouro',array('class' => 'col-md-3 col-xs-12 control-label'));
echo '<div class="col-md-6 col-xs-12">';
echo form_input(array('name'=>'logradouro', 'class'=>'form-control','placeholder'=>'Rua, Travessa, Avenida. Ex. Rua Maracangalha'), set_value('logradouro'));
echo '</div>';
echo '</div>';
echo '<div class="form-group">';
echo form_label('Número','numero',array('class' => 'col-md-3 col-xs-12 control-label'));
echo '<div class="col-md-6 col-xs-12">';
echo form_input(array('name'=>'numero', 'class'=>'form-control'), set_value('numero'));
echo '</div>';
echo '</div>';
echo '<div class="form-group">';
echo form_label('Bairro','bairro',array('class' => 'col-md-3 col-xs-12 control-label'));
echo '<div class="col-md-6 col-xs-12">';
echo form_input(array('name'=>'bairro', 'class'=>'form-control','placeholder'=>'Ex. Alegria'), set_value('bairro'));
echo '</div>';
echo '</div>';  
echo '<div class="form-group">';
echo form_label('Cidade','cidade',array('class' => 'col-md-3 col-xs-12 control-label'));
echo '<div class="col-md-6 col-xs-12">';
echo form_input(array('name'=>'cidade', 'class'=>'form-control'), set_value('cidade'));
echo '</div>';
echo '</div>';
echo '<div class="form-group">';
echo form_label('Estado','estado',array('class' => 'col-md-3 col-xs-12 control-label'));
echo '<div class="col-md-6 col-xs-12">';
echo form_input(array('name'=>'estado', 'class'=>'form-control'), set_value('estado'));
echo '</div>';
echo '</div>';
echo '<div class="form-group">';
