			...
			<div class="panel panel-default">
				...
				<tbody>
					...
					foreach ($query as $linha):
						...
						printf('<td class="text-center">%s%s</td>', anchor("posts/editar/$linha->id", ' <i class="glyphicon glyphicon-edit"></i> ', array('class'=>'table-actions table-edit', 'title'=>'Editar')), anchor("posts/excluir/$linha->id", ' <i class="glyphicon glyphicon-trash"></i> ', array('class'=>'table-actions table-delete deletareg', 'title'=>'Excluir')));
						echo '</tr>';
					endforeach;
					?>
				</tbody>
